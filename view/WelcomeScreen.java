...
public class WelcomeScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        if (!PacmanGame.assetManager.isFinished()) {
            game.font.draw(game.batch, "Wait... loading", PacmanGame.WINDOW_WIDTH / 2, PacmanGame.WINDOW_HEIGHT / 2);
        } else {
            ...
            game.font.draw(game.batch, "Press enter to play!", (int) (PacmanGame.WINDOW_WIDTH * 0.3), PacmanGame.WINDOW_HEIGHT / 4);
        }
        game.batch.end();
    }
